...
namespace DIA.ContentClassification.Services
{

    public class ObjectDetectionResult
    {
        public Image image { get; set; }
        public IEnumerable<BoundingBox> objectsDetected { get; set; }
    }

    public interface IObjectDetectionService
    {
        void DetectObjectsUsingModel(ImageInputData imageInputData);
        ObjectDetectionResult DrawBoundingBox(string imageFilePath);
    ...
    public class ObjectDetectionService : IObjectDetectionService
    {
        ...
        public ObjectDetectionResult DrawBoundingBox(string imageFilePath)
        {
            ...
            return new ObjectDetectionResult() { image = image, objectsDetected = filteredBoxes };
        }
    }
}
